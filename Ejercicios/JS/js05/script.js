...
let numero = 10;
numero++; // 11 devuelve el dato como antes de incrementar y despues incrementa
++numero; // 12 perimero incrementa y luego devuelve el valor ya incrementado
...
// Asignando el calor model del objeto auto a la constante model 
// Inicializar con un valor por default
// const { model, colorAuto = "Pistache" } = auto;
// console.log("Modelo " + model + " color " + colorAuto)

// Asignando el calor model del objeto del auto a la constante model
...
console.log(`El resultado de 9/5, cociente: ${division(9, 5)[0]}, residuo ${division(9, 5)[1]} `);
